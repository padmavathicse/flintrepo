 ...
 */
package com.flintgroup.test.setup;
...
import com.flintgroup.test.constants.Flintyb2bTestConstants;
import com.flintgroup.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Flintyb2bTestConstants.EXTENSIONNAME)
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			else
			{
				...
				importImpexFile(context, "/flintyb2btest/import/qa-test-users.impex");

				LOG.info("Creating Reviews...");
				importImpexFile(context, "/flintyb2btest/import/reviews.impex");
				...
				importImpexFile(context, "/flintyb2btest/import/cstickets.impex");

				LOG.info("Creating Test Quotes...");
				importImpexFile(context, "/flintyb2btest/import/csquotes.impex");
			}
		}
	}
}
