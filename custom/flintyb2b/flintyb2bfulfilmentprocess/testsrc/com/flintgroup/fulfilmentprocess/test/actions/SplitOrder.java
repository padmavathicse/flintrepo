 ...
 */
package com.flintgroup.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(Flintyb2bFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Flintyb2bFulfilmentProcessConstants.PARENT_PROCESS);
