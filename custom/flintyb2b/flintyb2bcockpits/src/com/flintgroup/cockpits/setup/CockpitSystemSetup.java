 ...
 */
package com.flintgroup.cockpits.setup;
...
import com.flintgroup.cockpits.constants.Flintyb2bCockpitsConstants;
 ...
 */
@SystemSetup(extension = Flintyb2bCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(Flintyb2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(Flintyb2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						Flintyb2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/flintyb2bcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
